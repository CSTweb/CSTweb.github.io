        ...
        try{
            ...
            using (var db = new CstwebEntities())
            {
                ...
                try
                {
                    ...
                    Linpre.PostBackUrl = "graduate-news-con.aspx?id=" + ne1.id.ToString();
                }
                catch {
                    Linpre.Text = "没有了";
                }
                try
                {
                    ...
                    Linnext.PostBackUrl = "graduate-news-con.aspx?id=" + ne2.id.ToString();
                }
                catch
                {
                    Linnext.Text = "没有了";
            ...
            Response.Redirect("graduate-list.aspx");
        }
    }
