<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="teacher-list3.aspx.cs" Inherits="teacher_list" %>
            ...
            <section class="right-content teacher-list-all box-shadow ">
                <section class="teacher-list">
                    <header class="border-dotted">
                        <span class="border-left">硕士生导师</span>
                    </header>
                    <ul>
