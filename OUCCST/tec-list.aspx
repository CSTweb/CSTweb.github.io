<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="tec-list.aspx.cs" Inherits="news_list" %>
        ...
        <section class="right-all clearfix">
            <section class="right-content news-list box-shadow">
                <header class="header-mid">
                    ...
                    <asp:Label runat="server" ID="hea" Text="科研动态"> </asp:Label>
                </header>
                <ul class="border-dotted">
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <li>
                                <a href="tec-con.aspx?id=<%#Eval("id") %>">
