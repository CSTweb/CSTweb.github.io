        ...
        try{
            ...
            using (var db = new CstwebEntities())
            {
                ...
                try
                {
                    ...
                    Linpre.PostBackUrl = "cooperation-news-con.aspx?id=" + ne1.id.ToString();
                }
                catch {
                    Linpre.Text = "没有了";
                }
                try
                {
                    ...
                    Linnext.PostBackUrl = "cooperation-con.aspx?id=" + ne2.id.ToString();
                }
                catch
                {
                    Linnext.Text = "没有了";
            ...
            Response.Redirect("cooperation-list.aspx");
        }
    }
