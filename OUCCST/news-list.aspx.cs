...
public partial class news_list : System.Web.UI.Page
{
    ...
    {
        if (!Int16.TryParse(Request.QueryString["nc"], out artclass)) artclass = 1;
        if (!Int32.TryParse(Request.QueryString["page"], out pageNum)) pageNum = 1;
        switch (artclass)
        {
            case 1: hea.Text = "本系动态"; break;
    ...
    protected void BtnPreviousPage_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("news-list.aspx?nc=" + artclass.ToString() + "&page=" + pageNum.ToString());
    }
