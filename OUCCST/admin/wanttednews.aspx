<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="wanttednews.aspx.cs" Inherits="admin_news1" %>
    ...
    <div id="content" class="container_16 clearfix">
        <div class="grid_5">
            <asp:DropDownList  AutoPostBack="True"  runat="server" ID="DdlSeClass" OnSelectedIndexChanged="DdlSeClass_SelectedIndexChanged">
                <asp:ListItem Value="9">招生公告</asp:ListItem>
                <asp:ListItem Value="10">招聘公告</asp:ListItem>
            </asp:DropDownList>
        </div>
        <div class="grid_16">
            <table>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("time")%></td>
                                <td><a href="wanttednewadd.aspx?id=<%#Eval("id")%>" class="edit">Edit</a></td>
                                <td>
        ...
        <asp:Literal ID="LtlArticlesCount" runat="server"></asp:Literal>
                            篇文章
                                <asp:Button ID="BtnAddnews" runat="server" Text="添加公告" OnClick="BtnAddnews_Click" />
                        </td>
