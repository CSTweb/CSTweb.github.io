...
public partial class admin_news1 : System.Web.UI.Page
{
        ...
        if (e.CommandName == "del")
        {
            using (var db = new CstwebEntities())
            {
                try
                {
                    ...
                    db.news.Remove(ne);
                    db.SaveChanges();
                    Response.Write("<script>alert('删除成功');window.location = 'competionnews.aspx';</script>");
                }
    ...
    protected void BtnPreviousPage_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("competionnews.aspx?page=" + pageNum.ToString());
        //TxtPageNum.Text = pageNum.ToString();
    }
    ...
    {
        Response.Redirect("competionnews.aspx?page=1");
    }

    protected void BtnTrailerPage_Click(object sender, EventArgs e)
    {
        Response.Redirect("competionnews.aspx?page=" + pageCount.ToString());
    }
    ...
    {
        Response.Redirect("competionnewadd.aspx");
    }
