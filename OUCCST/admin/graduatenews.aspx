<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="graduatenews.aspx.cs" Inherits="admin_news1" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("time")%></td>
                                <td><a href="graduatenewadd.aspx?id=<%#Eval("id")%>" class="edit">Edit</a></td>
                                <td>
