<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="games.aspx.cs" Inherits="admin_news1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="content" class="container_16 clearfix">
            ...
            <table>
                ...
                <tbody>
                    <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <td class="auto-style1"><%#Eval("gamename")%></td>
                                <td><%#Eval("addtime")%></td>
                                <td><a href="gameadd.aspx?id=<%#Eval("id")%>" class="edit">Edit</a></td>
                                <td>
        ...
        <asp:Literal ID="LtlArticlesCount" runat="server"></asp:Literal>
                            篇文章
                                <asp:Button ID="BtnAddnews" runat="server" Text="添加比赛" OnClick="BtnAddnews_Click" />
                        </td>
