<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" validateRequest="false" AutoEventWireup="true" CodeFile="wanttednewadd.aspx.cs" Inherits="admin_newsadd1" %>
    ...
    <div id="content" class="container_16 clearfix">
        ...
        <div class="grid_5">
            ...
            <asp:dropdownlist runat="server" ID="DdlNew">
                <asp:ListItem Value="9">招生</asp:ListItem>
                <asp:ListItem Value="10">招聘</asp:ListItem>
            </asp:dropdownlist>
        </div>
        <div class="grid_16">
            <p>
